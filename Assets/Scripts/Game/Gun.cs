...
public class Gun : MonoBehaviour
{
    ...
    public void ShootGun(Transform director)
    {
        ...
        if (shotgun)
        {
            ...
            {
                float random_spread = UnityEngine.Random.Range(-shotgunSpread, shotgunSpread);
                Quaternion spread = Quaternion.Euler(euler_angles.x, euler_angles.y, euler_angles.z + random_spread);
                SpawnBullet(player_position, spread);
            }
        }
        else
        {
            SpawnBullet(player_position, Quaternion.Euler(euler_angles));
        }
    }
